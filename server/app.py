...
# Interactive root endpoint with a custom UI (Bypasses Hugging Face iframe redirect issues)
...
def read_root():
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="btn-group">
                <a href="https://github.com/sriharizz/customs-trade-classification" target="_blank" class="btn">View GitHub</a>
                <a href="/docs" target="_blank" class="btn secondary">API Docs (Swagger)</a>
            </div>
